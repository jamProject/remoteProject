...
<script
	...
	crossorigin="anonymous"></script>
<spring:url value="/resources/mainPage/js/mainPageJs.js"
	var="mainPageJs" />
<spring:url value="/resources/mainPage/css/mainPageCss.css"
	var="mainPageCss" />
...
<body style="height: 1500px">
	...
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
		...
		<ul class="navbar-nav">
			<li class="nav-item"><a class="nav-link" href="map.manageplan">map</a>
			</li>
			<li class="nav-item"><a class="nav-link" href="plantable.manageplan">plan</a></li>
			<li class="nav-item"><a class="nav-link" href="viewall.manageplan">view all</a></li>
		</ul>
	</nav>

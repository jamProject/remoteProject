...
%>	
	...
	// 웹소켓에 해당하는 스크립트
	   ...
	   w = new WebSocket("ws://localhost:8800/jamplan/planMainChat?id=" + id + "&planNo=" + planNo);
	    	...
	    	<nav class="drawer-nav" role="navigation">
	     		<ul class="drawer-menu"> 
	        		<li><h2><a class="drawer-brand" href="#">Jam Planner</a></h2></li>
	       			<li><h3><a class="drawer-menu-item" href="#">Main</a></h3></li>
	        		<li><h3><a class="drawer-menu-item" href="#">My room</a></h3></li>
	      		</ul>
	    	</nav>
    	</div>
    	<!-- top bar 들어가는 부분 -->

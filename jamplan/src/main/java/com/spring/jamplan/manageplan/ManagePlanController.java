...
=======
	...
	public String calendarSelect(HttpSession session, CalendarVO vo) {
		...
		vo.setId((String)session.getAttribute("id"));
		vo.setPlanNo(Integer.parseInt(session.getAttribute("planNo").toString()));
		//List<CaledarVO> vo = 
		return "managePlan/calendarPage";
	}
	...
	@ResponseBody
	public String calendarLoadDate(HttpSession session) {
		ArrayList<CalendarVO> calVO = calDAOS.getSelectDate(Integer.parseInt(session.getAttribute("planNo").toString()));
